...
public class SceneManag : SingletonGeneric<SceneManag>
{
    ...
    public ProductCatagory currentProductCatagory = ProductCatagory.BODY;
    public ProductSubCatagory _currentProductSubCatagory = ProductSubCatagory.HARNESS;
    public HarnessSize harnessSize = HarnessSize.Large;
    /// <summary>
    ...
    public void ARHarnessScene()
    {
        ...
        SceneManager.LoadSceneAsync(1, LoadSceneMode.Single).completed += SceneManag_completed;
    }
